...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, boxes, features, ignore_box_regression=False):
        """
        Arguments:
                ...
                if not self.bbox_aug_enabled:  # If bbox aug is enabled, we will do it later
                    ...
                    if self.cfg.MODEL.ROI_HEADS.NMS_FILTER == 2:
                        ...
                        while new_boxlist.bbox.shape[0] < self.min_detections_per_img and decrease_num < 10:
                            ...
                            print(("\nNumber of proposals {} is too small, retrying filter_results with score thresh = {}").format(new_boxlist.bbox.shape[0], self.score_thresh))
                            new_boxlist = self.filter_method(boxlist, num_classes, feature)
                            decrease_num += 1
                        boxlist = new_boxlist
    ...
    def filter_results_peter(self, boxlist, num_classes, feature=None):
        ...
        for j in range(1, num_classes):
            ...
            boxlist_for_class = boxlist_nms(boxlist_for_class, nms_score)
        ...
        result = BoxList(boxlist.bbox.view(-1, 4)[box_inds_pre], boxlist.size, mode="xyxy")
